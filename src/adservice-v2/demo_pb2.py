...
_ADREQUESTV2 = _descriptor.Descriptor(
  name='AdRequestV2',
  full_name='hipstershop.AdRequestV2',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='context_keys', full_name='hipstershop.AdRequestV2.context_keys', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADRESPONSEV2 = _descriptor.Descriptor(
  name='AdResponseV2',
  full_name='hipstershop.AdResponseV2',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='ads', full_name='hipstershop.AdResponseV2.ads', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADV2 = _descriptor.Descriptor(
  name='AdV2',
  full_name='hipstershop.AdV2',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='redirect_url', full_name='hipstershop.AdV2.redirect_url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='text', full_name='hipstershop.AdV2.text', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADRESPONSEV2.fields_by_name['ads'].message_type = _ADV2
...
DESCRIPTOR.message_types_by_name['AdRequestV2'] = _ADREQUESTV2
DESCRIPTOR.message_types_by_name['AdResponseV2'] = _ADRESPONSEV2
DESCRIPTOR.message_types_by_name['AdV2'] = _ADV2
...
AdRequestV2 = _reflection.GeneratedProtocolMessageType('AdRequestV2', (_message.Message,), {
  'DESCRIPTOR' : _ADREQUESTV2,
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.AdRequestV2)
  })
_sym_db.RegisterMessage(AdRequestV2)

AdResponseV2 = _reflection.GeneratedProtocolMessageType('AdResponseV2', (_message.Message,), {
  'DESCRIPTOR' : _ADRESPONSEV2,
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.AdResponseV2)
  })
_sym_db.RegisterMessage(AdResponseV2)

AdV2 = _reflection.GeneratedProtocolMessageType('AdV2', (_message.Message,), {
  'DESCRIPTOR' : _ADV2,
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.AdV2)
  })
_sym_db.RegisterMessage(AdV2)
...
_ADSERVICEV2 = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=0,
    containing_service=None,
    input_type=_ADREQUESTV2,
    output_type=_ADRESPONSEV2,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
